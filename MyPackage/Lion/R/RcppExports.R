...
ReadBlock <- function(asciifname, start_row, numcols, numrows_in_block) {
    .Call('_Lion_ReadBlock', asciifname, start_row, numcols, numrows_in_block)
}
...
calculate_reduced_a_rcpp <- function(f_name_ascii, varG, P, y, max_memory_in_Gbytes, dims, selected_loci, quiet, message) {
    .Call('_Lion_calculate_reduced_a_rcpp', f_name_ascii, varG, P, y, max_memory_in_Gbytes, dims, selected_loci, quiet, message)
}

createM_ASCII_rcpp <- function(f_name, f_name_ascii, type, AA, AB, BB, max_memory_in_Gbytes, dims, quiet, message, missing) {
    .Call('_Lion_createM_ASCII_rcpp', f_name, f_name_ascii, type, AA, AB, BB, max_memory_in_Gbytes, dims, quiet, message, missing)
}
...
createMt_ASCII_rcpp <- function(f_name, f_name_ascii, type, max_memory_in_Gbytes, dims, quiet, message) {
    invisible(.Call('_Lion_createMt_ASCII_rcpp', f_name, f_name_ascii, type, max_memory_in_Gbytes, dims, quiet, message))
}
...
extract_geno_rcpp <- function(f_name_ascii, max_memory_in_Gbytes, selected_locus, dims) {
    .Call('_Lion_extract_geno_rcpp', f_name_ascii, max_memory_in_Gbytes, selected_locus, dims)
}
