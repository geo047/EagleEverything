...
#' @description Opens a web browser to act as a user-friendly interface to 'Lion'
#' @details
#' Once \code{OPenGUI} is run, your default web-browser will open automatically the Lion GUI. We have written our GUI in html code. 
...
#'
OpenGUI <- function() {
  appDir <- system.file('shiny_app', package = 'Lion')
  if (appDir == "") {
    message("Could not find shiny-app directory. Try re-installing `Lion` package.")
    return(NULL)
  }
