...
#' However, if a group/strain/line has multiple trait measurements (i.e. \eqn{n > n_g}) then the Z matrix is needed to tell EagleGPU which 
...
#' complete.name <- system.file('extdata', 'Z.txt', package='EagleGPU')
#'   
