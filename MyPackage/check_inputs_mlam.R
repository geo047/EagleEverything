...
if(is.factor(pheno[[colname.trait]])){
   message("Error: the trait data in ", colname.trait, " is of class factor. Lion can only handle quantitative traits.   \n")
...
if(is.null(geno)){
   ...
   message("       If you are using 'Lion' functions, then set the geno parameter to the ")
