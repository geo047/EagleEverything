...
// ReadASCIIWriteHDF_rcpp
bool ReadASCIIWriteHDF_rcpp(std::string asciifname, std::vector <long> dims, bool transpose);
RcppExport SEXP _Eagle_ReadASCIIWriteHDF_rcpp(SEXP asciifnameSEXP, SEXP dimsSEXP, SEXP transposeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(ReadASCIIWriteHDF_rcpp(asciifname, dims, transpose));
    return rcpp_result_gen;
END_RCPP
}
// ReadBlock
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_Eagle_ReadASCIIWriteHDF_rcpp", (DL_FUNC) &_Eagle_ReadASCIIWriteHDF_rcpp, 3},
